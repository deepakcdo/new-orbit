...
function testCircuitBreaker() {
    ...
    assertEqual "CLOSED" "$($EXEC wget product-composite:8080/actuator/health -qO - | jq -r .details.circuitBreakers.details.product.details.state)"
    ...
    assertEqual "HALF_OPEN" "$($EXEC wget product-composite:8080/actuator/health -qO - | jq -r .details.circuitBreakers.details.product.details.state)"
